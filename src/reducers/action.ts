...
export function setSpatempFilter(
  spatempfilter: SpatialTemporalFilter
): SpatialTemporalAction {
  return { type: ActionType.SET_SPATEMP, payload: spatempfilter };
}
export function setStoreCenter(center: Coordinate): CenterAction {
...
export function setStoreBoundbox(boundbox: Coordinate): BoundboxAction {
