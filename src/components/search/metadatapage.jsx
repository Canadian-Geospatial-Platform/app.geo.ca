                    ...
                    results.map((result) => {
                        ...
                        <aside className="col col-12 col-xl-4 aside">
                            ...
                            <section className="sec-search-result search-results-section search-results-misc-data">
                                ...
                                <div className="btn-group">
                                    <a href={`https://cgp-meta-l1-geojson-dev.s3.ca-central-1.amazonaws.com/${  result.id  }.geojson`} className="btn btn-search mr-2" role="button" rel="noreferrer" target="_blank">Download geoCore</a>
                                    <a href={`https://csw.open.canada.ca/geonetwork/srv/csw?service=CSW&version=2.0.2&request=GetRecordById&outputSchema=csw:IsoRecord&ElementSetName=full&id=${  result.id}`} className="btn btn-search" role="button" rel="noreferrer" target="_blank">View HNAP Record</a>
                                </div>
                            </section>
                        </aside>
                    </div>
